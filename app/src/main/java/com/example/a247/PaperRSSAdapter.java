...
public class PaperRssAdapter extends RecyclerView.Adapter<PaperRssAdapter.PaperRssViewHolder>{
    private Context context;
    private List<PaperRss> mlist;

    public PaperRssAdapter(Context context, List<PaperRss> mlist) {
    ...
    public void onBindViewHolder(@NonNull PaperRssViewHolder holder, int position) {
        ...
        holder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context,DetailPaperRss.class);
